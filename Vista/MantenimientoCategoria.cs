    ...
    public partial class MantenimientoCategoria : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (nombre != "Nombre")
            {
                try
                {
                    if (N_categoria.AgregarRegistro(nombre))
                    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (txtId.Text != "ID")
            {
                ...
                try
                {
                    ArrayList datos = N_categoria.BuscarRegistro(id);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (nombre != "Nombre")
            {
                try
                {
                    if (N_categoria.ModificarRegistro(id, nombre, estado))
                    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (N_categoria.EliminarRegistro(id))
                {
